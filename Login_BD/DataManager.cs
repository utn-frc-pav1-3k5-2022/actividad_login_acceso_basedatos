...
namespace Login_BD
{
    public class DataManager
    {
        ...
        public DataManager()
        {
            var string_conexion = "Data Source=.\\SQLEXPRESS;Initial Catalog=BugTracker93584;Integrated Security=True";
        ...
        public DataTable ConsultaSQL(string strSql, Dictionary<string, object> prs = null)
        {
            ...
            try
            {
                ...
                dbConnection.ConnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=BugTracker93584;Integrated Security=True";
                dbConnection.Open();
